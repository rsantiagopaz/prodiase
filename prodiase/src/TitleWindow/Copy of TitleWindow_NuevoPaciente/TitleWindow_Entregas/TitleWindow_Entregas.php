...
switch ($_REQUEST['rutina'])
{
	case "agregar_entrega" : {
		...
		if ($_REQUEST['a_hospital']=="true") {
			$sql = "INSERT entregas SET id_paciente='0', id_deposito='0', organismo_area_id='" . $xml['organismo_area_id'] . "', fecha='" . $fecha . "', estado='A'";
		} else {
			$sql = "INSERT entregas SET id_paciente='0', id_deposito='" . $xml['id_deposito'] . "', organismo_area_id='', fecha='" . $fecha . "', estado='E'";
		}
		mysql_query($sql);
		$auditoria_sql = $sql;
